    ...
    static class DeploymentController
    {
        ...
        public static void HandleDeploymentInput()
        {
            ...
            if (SwinGame.MouseClicked(MouseButton.LeftButton))
            {
                ...
                {
                    _currentDirection = Direction.UpDown;//improved
                }
        ...
        private static void DoDeployClick()
        {
            ...
            int row = 0;
            int col = 0;
            row = Convert.ToInt32(Convert.ToInt32(Math.Floor(Convert.ToDouble(mouse.Y - FIELD_TOP) / Convert.ToDouble(CELL_HEIGHT + CELL_GAP))));// improved
            col = Convert.ToInt32(Convert.ToInt32(Math.Floor(Convert.ToDouble(mouse.X - FIELD_LEFT) / Convert.ToDouble(CELL_WIDTH + CELL_GAP))));
        ...
        public static void DrawDeployment()
        {
            ...
            {
                int i = 0;
                i = Convert.ToInt32(System.Convert.ToInt32(sn) - 1);
                if (i >= 0)
                {
                    if (sn == _selectedShip)
                    {
