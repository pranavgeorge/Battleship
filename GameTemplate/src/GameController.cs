...
using static MyGame.MenuController;
using static MyGame.DiscoveryController;
using static MyGame.EndingGameController;
using static MyGame.HighScoreController;
using static MyGame.DeploymentController;
